...
var hallDisc = "With the CELLDOOR open you may now enter the HALLWAY. If you back away from the CELLDOOR PHIL reappears peaking from behind the door frame. As you move closer he disappears. You're now stood at just inside the HALLWAY next to the CELLDOOR. It is short. At the end of the HALLWAY is a large metal GATE. The floor is stone. The walls are polished stone. The cramped space intensifies the heat. <br><br> You may examine the BED, CHEST, WINDOW, GATE and ZORK.";

function enterHall(){
	'use strict';
	dispText.innerHTML = hallDisc;
	position = "HALLWAY";
}

function hallUse(object){
	'use strict';
	switch(object){
	case "RIB":
	...
	case "BELT":
		...
		break;
	case "GAUNTLET":
		feedback.innerHTML = ("The GAUNTLET has no use here. Find something to smash.");
		break;
	case "KEY":
		feedback.innerHTML = ("Find this key's home");
		break;
	case "BED":
	...
	case "ZORK":
		...
		break;
	case "PHIL":
		feedback.innerHTML = ("You can't find PHIL. A blessing, that is.");
		break;
	default:
...
function hallLook(object){
	...
	case "HALLWAY":
		...
		break;
	case "GATE":
		feedback.innerHTML = ("Tall and black iron. Get closer for a better look.");
		break;
	case "ZORK":
...
function hallSpeak(object){
	...
	case "HALLWAY":
		...
		break;
	case "GATE":
		feedback.innerHTML = ("You yell for the GATE. No answer comes. I guess it doesn't like you. I don't like you, either.");
		break;
	case "ZORK":
